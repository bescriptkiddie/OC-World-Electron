    ...
    >
        ...
        <div className="mono" style={{
          ...
          {Array.from({ length: 2 }).map((_, k) => (
            <React.Fragment key={k}>
              ...
              <span>{lang === 'en' ? 'v0.3 · glass' : 'v0.3 · 玻璃都市'}</span><span>·</span>
      ...
      <div style={{
        ...
        <div className="glass-soft" style={{
          ...
          {lang === 'en' ? 'OCWORLD · v0.3 · GLASS' : 'OCWORLD · v0.3 · 玻璃都市'}
        </div>
        ...
        <div className="heitai" style={{
          ...
          <div style={{ fontStyle: 'italic', fontWeight: 700, color: 'var(--ink-muted)' }}>
            ...
            <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
              <button
                ...
                style={{
                  ...
                  boxShadow: '0 8px 24px -6px rgba(230,59,46,0.5)',
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = 'translateY(-2px)';
                  e.currentTarget.style.boxShadow = '0 14px 30px -8px rgba(230,59,46,0.6)';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'none';
                  e.currentTarget.style.boxShadow = '0 8px 24px -6px rgba(230,59,46,0.5)';
                }}
              >
