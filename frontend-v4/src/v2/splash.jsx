// OCWORLD v2 splash — editorial entry, paper-cream + saturated OZ red.
// Hero: HELLO OC WORLD chunky, with subhead 「角落的住人」.

const BOOT_LINES_V2 = [
  ['00.00', 'OCWORLD · v2 · 你的桌面伙伴'],
  ['00.04', '为你预留一个 OC 位置 ·'],
  ['00.18', 'TA 还没有名字 · 等你命名'],
  ['00.31', 'ready · 推门'],
];
  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          'radial-gradient(900px 700px at 78% 22%, #f7e9c8 0%, transparent 60%), '+
          'radial-gradient(700px 600px at 14% 90%, #fae0d8 0%, transparent 55%), '+
          '#faf6ec',
    ...
    >
      ...
      {[
        ...
        <div key={i} aria-hidden style={{
          ...
          borderTop:    m.t ? '1px solid var(--ink)' : 'none',
          borderLeft:   m.l ? '1px solid var(--ink)' : 'none',
          borderRight:  m.r ? '1px solid var(--ink)' : 'none',
          borderBottom: m.b ? '1px solid var(--ink)' : 'none',
          opacity: 0.5, zIndex: 5,
        }} />
      ))}

      {/* Top marquee — kanji ribbon */}
        ...
        <div className="mono" style={{
          ...
          {Array.from({ length: 2 }).map((_, k) => (
            <React.Fragment key={k}>
              ...
              <span>桌面的住人</span><span>·</span>
              <span>你的专属虚拟角色</span><span>·</span>
              <span>v0.2 · 纸质都市</span><span>·</span>
      ...
      <div style={{
        ...
        <div className="heitai" style={{
          ...
          <div style={{
            fontFamily: '"PingFang TC","Noto Sans SC", sans-serif',
            fontStyle: 'italic',
            fontWeight: 700,
            color: 'var(--ink-muted)',
          }}>为你生成一个</div>
          <div style={{
            ...
            color: 'var(--ink)',
            marginTop: 2,
          }}>专属的 OC 角色<span style={{ color: 'var(--accent)' }}>。</span></div>
        </div>
        ...
        <div style={{
          ...
          <div className="mono" style={{
            ...
            {BOOT_LINES_V2.slice(0, shown).map(([t, msg], i) => (
            ...
            <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 0, fontSize: 11, fontWeight: 600, letterSpacing: '0.16em',
                  textTransform: 'uppercase',
                  animation: 'fade-in .4s ease-out',
                }}
              >
      ...
      <div style={{
        ...
        padding: '60px 30px',
        background: 'linear-gradient(180deg, #f5e9c8 0%, #faf6ec 100%)',
        overflow: 'hidden',
      }}>
        ...
        <svg aria-hidden viewBox="-200 -160 400 320" style={{
          ...
          <defs>
            <linearGradient id="plat" x1="0" y1="-1" x2="0" y2="1">
              ...
              <stop offset="1" stopColor="#f5e9c8" stopOpacity=".5"/>
            </linearGradient>
          </defs>
          {/* outer iso ring */}
          ...
          {/* floating cubes — wire */}
          <g stroke="var(--ink)" strokeWidth="1" fill="#fff">
