    ...
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.15 }}>
            ...
            <span className="mono" style={{ fontSize: 9, color: 'var(--ink-faint)', letterSpacing: '0.18em', marginTop: 1 }}>v0.3 · Glass</span>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 7 }}>
          <span className="mono" style={{ fontSize: 9.5, fontWeight: 600, color: 'var(--ink-muted)', letterSpacing: '0.2em', textTransform: 'uppercase' }}>{t('sidebar.affinity')}</span>
        ...
        <div style={{ height: 3, background: 'var(--line-soft)', position: 'relative', overflow: 'hidden', borderRadius: 99 }}>
          <div style={{
            width: (affinity / 1000 * 100) + '%', height: '100%',
        ...
        <div className="mono" style={{ marginTop: 8, fontSize: 9, color: 'var(--ink-faint)', letterSpacing: '0.18em', display: 'flex', justifyContent: 'space-between' }}>
          <span>{t('sidebar.day')} 27</span>
          <span>{lang === 'en' ? 'friend → close' : '朋友 → 挚友'}</span>
        </div>
      </div>
    </aside>
  );
